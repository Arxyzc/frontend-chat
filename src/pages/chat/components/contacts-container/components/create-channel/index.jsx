        ...
        <>
            ...
            <Dialog open={newChannelModal} onOpenChange={setNewChannelModal}>
                <DialogContent className="bg-gradient-to-b from-[#1A1A2E] to-[#16213E] border-2 border-[#EAEAEA] text-white w-[400px] h-[400px] flex flex-col">
                    <DialogHeader>
                        <DialogTitle>Por favor llene la información del nuevo canal</DialogTitle>
                    ...
                    <div>
                        ...
                        emptyIndicator={
                            <p className="text-center text-lg leading-10 text-gray-600" >Resultados no encontrados</p>
                        }
                        />
